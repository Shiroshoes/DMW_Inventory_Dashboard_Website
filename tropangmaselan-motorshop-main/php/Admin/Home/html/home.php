...
<head>
  ...
  <link rel="stylesheet" href="/website/tropangmaselan-motorshop-main/php/Admin/Home/css/home.css" />
...
<body>
  ...
  <header class="main-header">
    ...
    <nav aria-label="Main navigation">
      <a href="/website/tropangmaselan-motorshop-main/php/Admin/Home/html/home.php" class="active">Home</a>
    ...
    <section class="welcome-section">
      <div class="welcome-content">
        ...
        <button class="btn-tutorial">
          ...
          <a href="/website/tropangmaselan-motorshop-main/php/Admin/tutorial/tutorial.php" style="text-decoration: none; color: inherit;">
            Tutorial
          </a></button>
      </div>
    </section>
