...
<head>
  ...
  <link rel="stylesheet" href="/website/tropangmaselan-motorshop-main/php/Home/css/home.css" />
  <link rel="stylesheet" href="../../header/CSS/headerUnknown.css">
...
<body>
  ...
  <header class="main-header">
    ...
    <nav aria-label="Main navigation">
      <a href="/website/tropangmaselan-motorshop-main/php/Home/html/home.php" class="active">Home</a>
    </nav>
    ...
    <section class="welcome-section">
      <div class="welcome-content">
        ...
        <button class="btn-tutorial">
          ...
          <a href="/website/tropangmaselan-motorshop-main/php/tutorial/tutorial.php" style="text-decoration: none; color: inherit;">
            Tutorial
          </a></button>
      </div>
    </section>
  ...
  <script>
    if (window.history && window.history.pushState) {
      ...
      window.onpopstate = function() {
        window.location.href = '/website/tropangmaselan-motorshop-main/php/Home/html/home.php';
      };
    }
  </script>
</body>
