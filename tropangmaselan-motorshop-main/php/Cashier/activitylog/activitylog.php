...
$query = "SELECT log_id, record_date, total_entries, total_amount FROM activity_log WHERE user_id=?";
$params = [$user_id];
...
<head>
  ...
  <link rel="stylesheet" href="/website/tropangmaselan-motorshop-main/php/Cashier/activitylog/activitylog.css">
...
<body class="Log-In-Pov-body">
  ...
  <header class="main-header">
    ...
    <nav>
      ...
      <a href="/website/tropangmaselan-motorshop-main/php/Cashier/activitylog/activitylog.php" class="active">Activity Log</a>
    </nav>
    ...
    <section class="Log-In-Pov-list-section" style="flex:1 1 100%;">
      ...
      <table>
        ...
        <tbody>
          ...
          <?php else: ?>
            <tr>
              <td colspan="4" class="Log-In-Pov-empty">No activity found for selected dates</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
